...
public class Exercise {
    ...
    public void play(){
        ...
        System.out.println("INSTRU: " + MainMenuJFrame.getMainMenuJFrame(User.getUser()).instrument);
        player.play("i" + MainMenuJFrame.getMainMenuJFrame(User.getUser()).instrument + " " +musicPattern);
    }
